      ...
      <div className="flex-1 flex">
        <div className="hidden lg:flex lg:w-1/2 items-center justify-center p-12">
          <div className="max-w-lg text-center">
            <img src="/lets_get_you_in.png" alt="Create account illustration" className="w-full h-auto max-w-md mx-auto" />
          </div>
        </div>
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-8 pt-20 lg:pt-8">
          <div className="w-full max-w-md">
            <div className="lg:hidden flex justify-center mb-8">
              <img src="/lets_get_you_in.png" alt="Create account illustration" className="w-64 h-auto" />
            </div>
            ...
            <div className="flex justify-center space-x-8 mb-8">
              <button type="button" className="w-12 h-12 rounded-full bg-gray-100 flex items-center justify-center hover:bg-gray-200">
